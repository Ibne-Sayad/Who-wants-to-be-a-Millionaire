...
{
    char num;
    MessageBox(0,"Wrong key! Enter the correct one\n","error!",2);
...
{   char num;
    ...
    printf("\n\n\n\n\n\n");
    printf("\n                                                          >>Created by: Ibne Sayad\n                                                          >>Dept. of Software Engineering(SWE)\n                                                          >>ID:171-35-2115");
    printf("\n                                                          >>Hotline: +8801765350424    ");
    printf("\n                                                          >>Facebook: https://www.facebook.com/ibna.saad");
    printf("\n                                                          >>Email: ibnsaad8772@gmail.com\n\n\n\n");
    printf("\n                               *******COPYRIGHT AND All RIGHT RESERVED BY 'IBNE SAYAD' AND POWERD BY 'T3RM1NAL-07' ******* \n\n\n");
    printf("\n\n                                       Press <M> for main menu:\n");
            scanf("%s",&num);
            system("cls");
            main();
...
main()
{
    ...
    int choose;
    {
        ...
        printf("                                        \xB2\xB2           >>4.View score.                                             \xB2\xB2\n");
        printf("                                        \xB2\xB2           >>5.Admin panel.                                            \xB2\xB2\n");
        printf("                                        \xB2\xB2           >>6.About us.                                               \xB2\xB2\n");
        printf("                                        \xB2\xB2                                                                       \xB2\xB2\n");printf("                                        \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2                                                     \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
...
display_all()
{
   ...
   // FILE *f;
    ...
    {
    if(reg.name != 0 && reg.score2 != 0 && reg.ac2 != 0) {
